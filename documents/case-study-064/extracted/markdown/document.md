...
PermaFrost NMR® in the two CRAC (Computer Room Air Conditioning) units supporting the critical data

center in the Regional US Bank facility at [LOCATION REDACTED], [CITY REDACTED], NY. Detailed forensic performance testing

(outlined later in this report) was performed on the two nominal 6-ton CRAC units using R22 refrigerant.

Following testing, the CRAC units were treated with the proper amount and type of the PermaFrost NMR®
...
This is a result of the reversal of thermal inefficiency on

heat exchange surfaces.

Following treatment with the PermaFrost

NMR® technology, the CRAC units showed an

effective net average 27.5% reduction in

kW/ton based on the exact capacity measured

in the baseline M&V and the post gestation

M&V. With each of the 6-ton CRAC units

operating at 100%, the units showed an

average 31.8% reduction in kWh while simultaneously producing an average increase in system efficiency of

23.1%. Prior to the ECM, the units each produced an average of 4.12 tons of cooling. After the ECM, the

average tonnage produced increased to 5 tons. This 21.4% average capacity increase from the baseline

performance level led to an effective average increase in COP of 39.4%. All of these factors directly correlate

to what Regional US Bank will realize in energy savings as they operate these CRAC units in the future under the
...
Following treatment with the PermaFrost NMR® technology, the two CRAC units also showed an

average drop in Amps from 9.125 to 8.05, equating to a 11.8% reduction while at the same time the CRAC

units were each producing more cooling. This is illustrated by the 21.4% increase in the enthalpy delta,

which is a critical HVAC measurement used to determine the thermodynamic enhancement brought

about by the PermaFrost NMR® ECM.  The result of the ECM improvement is an ROI to Regional US Bank that is

measured in months. The tables of data used to determine the financial payback are available for review
...
proper amount and type of PermaFrost NMR® was injected. The gestation period for the Regional US Bank pilot
...
Verification Protocol (IPMVP) as the M&V plan. [HVAC Technician], the Building Technology Company technician under

contract to [Facility Manager] at Regional US Bank and responsible for maintaining all of the HVAC in the facility,

witnessed the collection of all the data used in this report. The final calculations were performed by
...
These units provide critical cooling for the local Regional US Bank Data Center located on the 8th floor of the Regional US Bank

facility located at [LOCATION REDACTED], [CITY REDACTED], NY. Given the internal load from the Data Center year round, it

is estimated that each of the units ran ~3,750 hours each per year prior to the ECM being implemented.
...
and wet bulb temperatures entering the coil were very similar in both periods so no adjustments were made to

the calculations. The measurements are as follows:
...
Post measurement period of CRAC Units 1 & 2.

PermaFrost NMR®: Determining the Payback Period for Regional US Bank

Utilizing data in the above charts, to obtain a true avoided energy cost and subsequent payback period for Regional US Bank for

implementing the PermaFrost NMR® ECM, a detailed Regression Analysis is used to account for the average

amount of tonnage restored to both CRAC units. Once the average percentage of improvement in capacity is

determined, the average kWh associated with both CRAC units in the Post is then reduced by the same percentage to

account for the average reduced number of hours the CRAC units will be required to run in the future to maintain the

same set points. The average cost to operate each of the CRAC units prior to introduction of the ECM is then compared

to the newly obtained average cost to operate each of the CRAC units following the installation of the ECM to

determine the estimated Payback Period for Regional US Bank.

Baseline kWh         6.515 kW * 3,750 Annual Operating Hrs = 24,431.25 kWh

Cost to Run Baseline         24,431.25 kWh * $.10 = $2,443.13

Post ECM kWh         5.77 kW * 3,750 Annual Operating Hrs = 21,637.5 kWh

Revised kWh (based on 21.2% restored capacity)         21,637.5 kWh * (1 - .212) = 17,050.35 kWh
...
Revised Cost to Run Post         17,050.35 kWh * $.10 = $1,705.04

Avoided Energy Costs (Savings) Per Month         ($2,443.13 - $1,705.04) / 12 = $61.51
