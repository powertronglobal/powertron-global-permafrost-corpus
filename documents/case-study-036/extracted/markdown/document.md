# Caribbean Telecom Provider Confirmatory Report.pdf
...
without prior written approval. © Copyright 2018 Powertron Global, LLC.

Measurement & Verification (M&V) Report 
PermaFrost NMR® Confirmatory Testing and Results

Caribbean Telecom Group - [Jamaica Location]

Q1 2018

Project Overview   To determine the performance improvements on three DX systems

treated with PermaFrost NMR®

Representatives 
Caribbean Telecom Group

[Client Representative], Senior Engineering Manager

HVAC Contractor C

[HVAC Service Contractor], HVAC service contractor 
...
Process 
Testing was performed two split systems and one CRAC unit
...
Caribbean Telecom Group conducted three confirmatory tests from Q1 2018 to Q1 2018 located in [Jamaica Location] to verify Powertron Global’s PermaFrost 
NMR® energy efficiency improvement effect on three DX system’s refrigeration 
circuits:
...
For these HVAC/R systems parameters were measured every 5 seconds for a 
period of seven (7) and four (4) days to develop a scientific baseline and to 
capture post data measurements. Data was extracted from the same parameters 
every fifteen (15) seconds during all operating hours.
...
will affect the design capacity. An analysis is provided of the seven (7) day & four 
(4) day periods of performance profiles of subsequent kW/ton, EER and COP 
across a variation of outdoor air temperatures spanning a twenty-five (25) degree 
span (70ºF-95ºF). 
...
The Caribbean Telecom Group’s test results for the three (3) treated HVAC/R systems are 
consistent with previously tested systems at Caribbean Telecom Provider in 2015-16, UL (formerly, 
Underwriters Laboratories) lab & field tests and the more than 300 independent 3rd 
party M&V studies which have been conducted on PermaFrost NMR® to restore 
the evaporator and condenser heat transfer capabilities, thereby increasing 
cooling capacity while lowering the electrical cost per ton of cooling (kW/ton).
...
I. 
[Jamaica Site A] DX Performance Analysis Summary (4 days) 
II. 
[Jamaica Site B] DX Performance Analysis Summary (4 days) 
III. 
Downtown DX Performance Analysis Summary (7 days) 
IV. 
35 Points Measured  
...
Kit 1 Caribbean Telecom Provider [Jamaica Site A] POST
...
HVAC Performance Comparison: kW/Ton
Kit 3 Caribbean Telecom Provider [Jamaica Site B] POST
...
HVAC Performance Comparison: kW/Ton
Kit 4 Caribbean Telecom Provider Downtown POST
