...
support the Energy Solutions Company Holding Company Headquarters, [LOCATION REDACTED], Puerto Rico.
...
The following IPMVP data points were recorded on Q1 2015 using recently calibrated devices by NIST

(National Institutes of Standards and Technology) to insure measurement accuracy. The DX unit was then treated with

PermaFrost NMR® on the same day and allowed to run until Q2 2015 to ensure the patented surface science
...
DX Units Eﬃciency with PermaFrost NMR® ECM
