...
Participants:
     Major Healthcare Provider [Hospital Name]
...
This report is provided to Major Healthcare Provider [Hospital Name]. It is confidential and proprietary to Powertron Global®, LLC. 
...
that supports the Major Healthcare Provider [Hospital Name] in [LOCATION REDACTED], HI.
...
of the Major Healthcare Provider, [Personnel Name] of Technology Partner; and Powertron Global’s Director of Engineering,
...
The following IPMVP data points were recorded on Q2 2016 using the flow meter recently calibrated by NIST (National
...
PermaFrost NMR® and allowed to run normally until Q3 2016 to ensure the patented surface science nanotechnology had
...
Major Healthcare Provider [Hospital Name] has the problem of thermal degradation in its Chillers and HVAC systems. The
...
Major Healthcare Provider [Hospital Name] is Saving More than Just Energy
...
[LOCATION REDACTED]. Imagine how great the environmental impact will be when Major Healthcare Provider moves forward with treating all
