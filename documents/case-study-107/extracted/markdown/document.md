# Tea factory_Beverage Company A.pdf
...
(ECM) in a water-cooled package unit at the Beverage Company/Beverage Company Beverage Company B Factory and document the future avoided

energy costs associated with the same.
...
2. The actual cost of power required to produce the amount of cooling tons the PU is delivering as
...
area in the fall and winter which ensured repeatability of similar weather for the post testing measurements.

The weather and factory conditions on both days provided an adequate heat load on the facility to ensure both

compressors in the system would remain running during the actual data collection period. The boundary of

the testing was the PU and nothing else; therefore confidence in the accuracy of the performance calculations
...
43% of the original design efficiency in the baseline. The actual design rated tonnage of the PU is 20 tons. In

actuality, the PU was only producing a total of 8.4 tons of cooling at the start of the pilot. Approximately half of

this 57% efficiency loss is directly attributable to the thermal degradation of the heat exchange surfaces over a

short period of time. This is due in large part to thermal degradation which creates an insulating barrier to heat
...
After the ECM was installed, the average efficiency in the PU increased to 54% of design specifications,

equating to 10.8 total tons. The restoration of 2.4 tons represents a 28.6% increase in capacity.
...
operate the pilot PU as calculated in kW/ ton was 2.24 in the Baseline. When new, the kW/ton rating for units

like these usually ranges from .9 - 1.05 kW/ton when the proper sized ducting is used.

The restored average kW/ton rating following the ECM is now 1.77. This represents a 20.9% reduction in

energy costs from the baseline for every ton of cooling produced. This will result in an initial payback period

(IPP) to the Tea Factory of approximately 22 months and an internal rate of Return (IRR) of 54.3%. Extrapolated

out over just the next five (5) years, this ECM project will net the Tea Factory a substantial ROI of 272% on their
...
• The CRAC should be operating @ 20 tons of cooling capacity

• The CRAC was operating @ 8.4 tons of cooling capacity prior to

installing ECM

• The CRAC now has 2.4 tons of restored cooling capacity after ECM

• The CRAC should be operating @ 3.5 COP or higher

• The CRAC was operating @ 1.57 COP prior to the ECM

and 1.99 following the ECM

• The COP of the CRAC was increased by 26.8% following
...
restoration PermaFrost NMR® created in the treated PU.

The average cost to operate this PU before

it was treated with PermaFrost NMR®, as

calculated in kW/ton, was 2.24.

The specific cost to operate this PU after it was

treated with PermaFrost NMR®, as calculated

in kW/ton, is currently 1.77.

After factoring in the amount of loss in this system due to improperly sized ducting, the baseline kW/ton

ratings measured in-situ were expected when compared to the ASHRAE loss of performance efficiency and

cost to operate estimations for seven (7) year old equipment. The post results are also in line with the

average improvement savings shown over more than 120,000 installations globally.

Cost Savings for Tea Factory when Implementing ECM in all 13 HVAC PU’s

The Beverage Company B Factory packaging area has a total 188 tons of HVAC. The amount of ECM required to treat

this facility was 188 ounces. At a cost to treat all 13 PU’s of $37,600, the Internal Rate of Return to Beverage Company is

54.3% or a 22 month Initial Payback Period.
...
Adjusted Baseline Tonnage: 10.8 tons

Adjusted kW Baseline: 2.24 kW/ton * 10.8 tons = 24.19 kW

Adjusted Baseline kWh: 24.19 kW * 4,080 Annual Operating Hrs = 98,695 kWh

Revised Cost to Run Baseline: 98,695 kWh * $.105 = $10,363

Post Energy Consumption

kW Post: .1.77 kW/ton * 10.8 tons = 19.12 kW

Annual kWh Post: 19.12 kW * 4,080 hours = 78,010 kWh

Annual Cost Post: 78,010 kWh * .105 cents = $8,191

Savings Per Year

Avoided Energy Cost (savings) Per Year: $10,363 - $8,191 = $2,172

Estimated Energy Savings Per Month: $2,172 / 12 = $181

Return On Investment

Cost of PermaFrost NMR® installed in the pilot PU: $4,000

Estimated Initial Payback Period for Tea Factory on the PU: $4,000 / $181 = 22 months

Total kWh saved by treating this PU = 20,685
...
Incoming CDW in the Post was 2 degrees warmer equating to 2.6%. This requires 
