...
PermaFrost NMR® in two HVAC Roof Top Units (RTUs) supporting the Company A Diagnostic Clinic located at

[Brooklyn Location].  Detailed forensic performance testing (outlined later in this report) was

performed on the two RTUs, the first a 5-ton RTU supporting the rear break area and the second a 10-ton

RTU supporting the front Lobby and waiting area. Both of the RTUs are using R22 refrigerant.  Following

testing, the RTUs were treated with the proper amount and type of the PermaFrost NMR® technology

specially formulated for these types of systems.  Measurement and Verification (M&V) was conducted

pre-installation and post-gestation.

The improvement in efficiency and restored

capacity gained directly at the units was solely
...
technology, the RTUs showed an effective net

average 22.8% reduction in kW/ton based on the

exact capacity measured in the baseline M&V and

the post gestation M&V. With each of the RTUs

operating at 100%, the units showed an average

6.3% reduction in kWh while simultaneously producing 2.11 more tons or 18.2% more overall system

capacity.  Prior to the ECM, the RTUs were averaging 73.5% of design capacity as measured in-situ. After the

ECM, the RTUs jumped up to 89.4% of original design specification. This 15.9% efficiency improvement

compared to design combined with the 25% improvement in refrigerant approach from the baseline

performance levels led to an effective average increase in COP of 31.6%. All of these factors directly correlate

to what Company A will realize in energy savings as they operate these RTUs in the future as well as all

their other HVAC equipment like Roof Top Units and Chillers under the similar parameters.

Energy Science Division

The 10-ton Lobby RTU (similar to the one pictured above) runs

approximately 3,000 annually, while the smaller Break Area RTU runs

only approximately 2,000 annually. Both RTUs were put into service
...
Following treatment with the PermaFrost NMR® technology, the two RTUs also showed a slight

reduction in measured Amps and Volts while at the same time producing more cooling. This is

illustrated by the 22.3% increase in the enthalpy delta, which is a critical HVAC measurement used to

determine the thermodynamic enhancement brought about by the PermaFrost NMR® ECM.  The result

of the ECM improvement is an ROI to Company A that is measured in months. The tables of data

used to determine the financial payback are available for review at the end of this report.
...
cycle time and a reduced carbon footprint for Company A.
...
conditions of the RTUs were satisfactory. Baseline M&V were recorded on both RTUs and then the proper

amount and type of PermaFrost NMR® was injected. The gestation period for the Company A pilot was just 21

days on these particular units to allow them to achieve the required ~200 hours of runtime on each to ensure

adequate performance improvement time. At the end of this gestation period, Post M&V results were taken

in the identical manner as in the baseline, taking special care to match the same or very similar entering air

dry bulb and wet bulb temperatures, discharge pressures and of course outdoor air temperatures (OAT).

These are three of the most critical variables to contend with in an in-situ testing situation. When analyzing

all of the data baseline and post data, no adjustments for weather were deemed necessary.

The following report produces the utilization of the International Performance Measurement and

Verification Protocol (IPMVP) as the M&V plan. Company A's CFO, [Client CFO], authorized the pilot.  The data

was collected and final calculations performed by Powertron Global®’s Forensic Mechanical Engineer,
...
Detailed Results for Company A Roof Top Units

System Description / Design Characteristics

These units provide comfort cooling for the for the rear break area and front lobby/waiting areas respectively

located at [Brooklyn Location].  Given much of the load in the two areas being served are very much

dependent on patient and staff traffic in and out, it is estimated that the 5-ton RTU operates ~2,000 per year and

the 10-ton RTU operates ~3,000 hours per year prior to the ECM being implemented.
...
and wet bulb temperatures entering the coil were very similar in both periods as were the discharge pressures

of the compressors. The OAT was also very similar, being just 2.6 degrees cooler in the Post so no adjustments

were made to the calculations. The measurements are as follows:
...
Post measurement period of the two RTUs prior using regression analysis.

PermaFrost NMR®: Determining the Payback Period for Company A

Utilizing data in the above charts, to obtain a true avoided energy cost and subsequent payback period for Company A

Diagnostics for implementing the PermaFrost NMR® ECM, a detailed Regression Analysis is used to calculate the

true energy savings resulting from the improvement in capacity. This greater capacity reduces the runtime hours and

in turn reduces the annual kWh expended in the Post. The true ROI comes from determining what the cost to run the
...
Avg. Adjusted kW Baseline        1.251 Avg kW/ton * 6.84 Avg tons = Avg 8.56 kW

Avg. Adjusted Baseline kWh        8.56 kW * 2,500 Avg Annual Operating Hrs = 21,400 kWh

Avg. Revised Cost to Run Baseline        21,400 kWh * $.18 = $3,852.00
...
Avg. kW Post        .969 kW/ton * 6.84 tons = 6.63 kW

Avg. Annual kWh Post         6.63 kW * 2,500 hours = 16,575 kWh

Avg. Annual Cost Post         16,575 kWh * .18 cents = $2,983.50

Avg Avoided Energy Cost (savings) Per Month       ($3,852.00 - $2,983.50)/12 = $72.38

Avg Cost of PermaFrost NMR® installed per Unit        $937.50

Avg. Payback Period for Company A on Both RTUs         $937.500 / $72.38 = 13 months
