...
Major Global Bank/Property Management Firm - [Northeast Location] Data Center - CH #3 & #4

Study Date:

Sep 22, 2014  - May 07, 2015
...
The chillers in this study (pictured below) are representative of a great majority of the portfolio of equipment

operated by Major Global Bank. If thermal degradation is present in this chiller it is present in the entire inventory of
...
the Major Global Bank Data Center in [Northeast Location], NJ.

Detailed performance testing (outlined later in this report) was performed on the chillers before and after the

installation of the PermaFrost NMR® ECM to determine the impact on the three key elements that greatly

affect the HVAC/R power bill as they relate to the original design specifications:

1. The cooling capacity the chillers produce after 11.5 (on average) years in service, before and after

the administration of the ECM.
...
IPMVP (International Measurement and Verification Protocol) framework. The team consisted Frank Sherry

Operations Manager with Commercial Real Estate Services/Major Global Bank Realty Services and Powertron Global’s Director of

Engineering, [Senior Energy Engineer].

Notes

The equipment measured were two YS water-cooled chillers manufactured by York. The GPM through the evaporator, the

incoming condenser water and the return chilled water in the baseline and post were matched closely so no adjustments
...
The content detailed in this report will first demonstrate the ability of the chillers to perform prior to the
...
data was collected and recorded by the M&V team. 400+ runtime hours after installation of the PermaFrost NMR®
...
The following IPMVP data points were recorded on 22 September 2014 using a flow meter recently calibrated by NIST

(National Institutes of Standards and Technology) to insure measurement accuracy. The remaining measurements were

taken directly from the chiller’s control panel. The chiller was then treated with PermaFrost NMR® on the same day and

allowed to run normally until 7 May 2015 to ensure the patented surface science nanotechnology had ample time to seat

into all the metal surfaces of the heat exchangers. All measurements were taken at similar incoming water temperatures.

The collection of data, in both the baseline and post periods, was witnessed by [Witnesses] of
...
Recovered Wasted Energy with ECM - Chiller #3
...
11.5 year-old year old chillers utilizing R-22 refrigerant.
...
Recovered Wasted Energy with ECM - Chiller #4
...
The specific cost to operate the chiller after it was

treated with PermaFrost NMR®, as calculated in

kW/ton, is currently .566.
...
Post measurement period for the Major Global Bank Data Center Chillers 3 & 4.

Baseline Energy Consumption

Baseline Tonnage: 639 tons

Adjusted kW Baseline:  .635 kW/ton * 648 tons = 411.48 kW

Adjusted Baseline kWh: 411.48 kW * 5650 Annual Operating Hrs = 2,324,862 kWh

Revised Cost to Run Baseline: 2,324,862 kWh * $.11 = $255,734

Post Energy Consumption

kW Post: .595 kW/ton * 648 tons = 385.56 kW

Annual kWh Post: 385.56 kW * 5650 hours = 2,178,414 kWh

Annual Cost Post: 2,178,414 kWh * .11 cents = $239,626

Savings Per Year

Avoided Energy Cost (savings) Per Year: $255,734 - $239,626 = $16,108

Estimated Energy Savings Per Month: $16,108 / 12 = $1,342

Initial Payback Period

Cost of PermaFrost NMR® installed in the chillers (3 & 4): $13,708

Estimated ROI Period for Major Global Bank on the chillers: $13,708 / $1,342 = 10.2 months

Annual Rate of Return = 117.5%

Return on Investment Over 5 Years = 587.5%
...
The chiller provides cooling to the data center in

[Northeast Location]. Given the facility load and the two

chillers partially comprising the plant, this

chiller runs approximately 5,600 hours or more
...
chiller runs approximately 5,700 hours or more
...
Major Global Bank/Property Management Firm is Saving More
than Just Energy

By treating the chillers with PermaFrost NMR®, based on the current manner in which Major Global Bank/Commercial Real Estate Services operates the chillers, it will save approximately 146,448 kWh per year and all the costs

associated with those savings. From an environmental impact standpoint, Major Global Bank/Commercial Real Estate Services

is also benefitting the surrounding community of [Northeast Location], NJ. Imagine how great the environmental

impact will be when Major Global Bank moves forward with treating all their chiller equipment in all their properties

across their portfolio.

The 146,448 kWh saved per year equates to preventing 101 metric tons of greenhouse gas emissions from
