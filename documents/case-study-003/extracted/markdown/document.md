...
refrigerant. [Government Services Director], Deputy Director of Government Services for [Energy Services Company], personally witnessed
...
This CRAC unit provides the critical 24/7 cooling to the [Data Center REDACTED] at Military Base A and runs 3,920
...
The identical IPMVP data recordings from the baseline were recorded on Q3 2012 using the same
...
This CRAC unit provides the critical 24/7 cooling to the [Data Center REDACTED] at Military Base A and runs 4,210

hours per year according to the runtime logger on the unit.

Baseline Measurement Period Selection

TThe following data was recorded on Q3 2012 using recently NIST calibrated devices to insure
