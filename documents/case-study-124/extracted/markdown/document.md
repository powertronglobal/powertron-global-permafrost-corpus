...
supports the Non-Profit Organization Leeward Brach in [LOCATION REDACTED], HI.
...
IPMVP (International Measurement and Verification Protocol) framework. The team consisted [Personnel Name] of

the Non-Profit Organization, [Personnel Name] of [Energy Services Company]; and Powertron Global’s Director of Engineering,
...
The following IPMVP data points were recorded on Q1 2016 using recently calibrated by NIST (National Institutes of
...
then treated with PermaFrost NMR® on Q2 2016 and allowed to run normally until Q2 2016 to ensure the patented
...
[LOCATION REDACTED]. Imagine how great the environmental impact will be when Non-Profit Organization moves forward with treating
