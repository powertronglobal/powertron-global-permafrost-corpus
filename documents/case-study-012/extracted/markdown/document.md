# Regional Healthcare Provider.pdf

Energy Science Division

®

Regional Healthcare Provider SCHOOL
...
York Split System Servicing Finance Oﬃce
...
This report contains specific information regarding the installation of PermaFrost NMR® in the 7.5-ton York

DX Split HVAC unit at Regional Healthcare Provider School Finance Office.  The unit is owned and maintained by

Regional Healthcare Provider (heretofore referred to as The School) located in [LOCATION REDACTED], MD. [Director of Facilities], Director of

Facilities, oversaw the trial.
...
The pool area was in use in the Post testing period and unoccupied during Pre testing.  When the pool is in

use the door to the locker room and the hallway entering the entrance area to the locker room is wedged

open in case of an emergency and the possible need of emergency response.  This allows the very moist and

warm air to enter the building finance side of the building.  During the Post testing period there was an

enormous load coming from the pool.

The overall system efficiency improved by 18% and the EER improved by 48.7%.  There was an increase in

coil capacity of 16,200 in Btuh which equates to gaining 1.35-tons of capacity or 20.9%.  There is also a

reduction of 32.7% in total power and watts per ton which is another measurable way to view the
...
ROI to The School of 1.7 years.
...
The School made the decision to treat the unit as it was the on the same meter as the pool unit so the school

can also monitor that meter for a reduction in kWh when adjusted for weather.  A diagnostic examination of

the pilot equipment was implemented to determine if the unit’s operational conditions were satisfactory.

Baseline measurements were recorded and then the proper amount and type of PermaFrost NMR™ was

injected.  The product was then allowed four (4) weeks to seat itself into the metal surfaces before post

measurements were taken to establish the efficiency gains.
...
This unit provides cooling for The School’s finance offices.  Per The School, the equipment is estimated to

run 1,440 hours per year.
...
Baseline kWh = (8517.6 CTW / 1,000) * 1,440 Annual Operating Hrs = 12,265 kWh

Baseline Cost To Run = 12,265 kWh * $.11 = $1,349

Regression Analysis is then used to account for amount of tonnage restored to Unit #1

Adjusted Base Tonnage = 7.81 tons (ERP) – 6.46 (base) = 1.35 tons + 6.46 tons = 7.81 tons

Adjusted Total Watts = 1,318.5 WPT * 7.81 tons = 10,297 W

Adjusted Base kWh = (10,297 W/1,000) * 1,440 Annual Operating Hrs = 14,828 kWh

Revised Cost to Run Prior to ECM = 14,828 kWh * $.11 = $1,631

Post ECM kWh = (6,927.8 W / 1,000) * 1,440 Annual Operating Hrs = 9,976 kWh

Cost to Run After ECM = 9,976 kWh * $.11 = $1,097

Cost Savings per Month = ($1,631 - $1,097) / 12 = $44.50

Cost of PermaFrost NMR® installed @ $840 / $44.50 = 18.9
